...
public class HuowuchukuServiceImpl extends ServiceImpl<HuowuchukuDao, HuowuchukuEntity> implements HuowuchukuService {
    ...
    @Override
	public List<HuowuchukuVO> selectListVO(Wrapper<HuowuchukuEntity> wrapper) {
 		return baseMapper.selectListVO(wrapper);
	}
	
	@Override
	public HuowuchukuVO selectVO(Wrapper<HuowuchukuEntity> wrapper) {
