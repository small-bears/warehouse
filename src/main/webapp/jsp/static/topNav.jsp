<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		.top-brand {
			...
			background-color: rgba(251, 162, 100, 1);
		...
		.top-brand .nav .dropdown-menu.profile::before {
			left: 100%;
			margin-left: -28px;
			border-bottom-color: rgba(251, 162, 100, 0.53);
		}
		...
		.top-brand .nav .dropdown-menu.profile h5 {
			...
			border-style: solid;
			border-color: #333;
			background-color: rgba(251, 162, 100, 0.53);
			box-shadow: 0 0 0px rgba(30, 144, 255, 0);
			text-align: center;
		}
		...
		.top-brand .nav .dropdown-menu.profile .web:hover{
			...
			border-style: solid;
			border-color: rgba(0,0,0,.3);
			background-color: rgba(251, 162, 100, 0.82);
			box-shadow: 0 0 6px rgba(30, 144, 255, 0);
		}
		...
		.top-brand .nav .dropdown-menu.profile .exit:hover{
			...
			border-style: solid;
			border-color: rgba(0,0,0,.3);
			background-color: rgba(251, 162, 100, 0.91);
			box-shadow: 0 0 6px rgba(30, 144, 255, 0);
		}
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">仓库管理系统设计与实现</a>
						</div>
