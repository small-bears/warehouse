		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑厂商信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑厂商信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">厂商信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>厂商编号</label>
										<input name="changshangbianhao" id="changshangbianhao" name="changshangbianhao" class="form-control" placeholder="厂商编号">
									</div>
									<div class="form-group col-md-6">
										<label>厂商名称</label>
										<input name="changshangmingcheng" id="changshangmingcheng" name="changshangmingcheng" class="form-control" placeholder="厂商名称">
									</div>
									<div class="form-group col-md-6">
										<label>负责人</label>
									...
									<div class="form-group col-md-6">
										<label>厂商地址</label>
										<input name="changshangdizhi" id="changshangdizhi" name="changshangdizhi" class="form-control" placeholder="厂商地址">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "changshangxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("changshangxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("changshangxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("changshangxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#changshangbianhao").val(ruleForm.changshangbianhao);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.changshangbianhao != null && res.data.changshangbianhao != ''){
						...
						$("#changshangbianhao").val(res.data.changshangbianhao);
						$("#changshangbianhao").attr('readonly','readonly');
					}
