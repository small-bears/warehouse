					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑司机信息</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>司机姓名</label>
										<input name="sijixingming" id="sijixingming" name="sijixingming" class="form-control" placeholder="司机姓名">
									</div>
									<div class="form-group col-md-6">
										<label>性别</label>
									...
									<div class="form-group col-md-6">
										<label>驾龄</label>
										<input name="jialing" id="jialing" name="jialing" class="form-control" placeholder="驾龄">
									</div>
									<div class="form-group col-md-6">
										<label>司机手机</label>
										<input name="sijishouji" id="sijishouji" name="sijishouji" class="form-control" placeholder="司机手机">
									</div>
									<div class="form-group col-md-6">
										<label>身份证</label>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("sijixinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("sijixinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("sijixinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#sijixingming").val(ruleForm.sijixingming);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.sijixingming != null && res.data.sijixingming != ''){
						...
						$("#sijixingming").val(res.data.sijixingming);
						$("#sijixingming").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.jialing != null && res.data.jialing != ''){

						$("#jialing").val(res.data.jialing);
						$("#jialing").attr('readonly','readonly');
					}
