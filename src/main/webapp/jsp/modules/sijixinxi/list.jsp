...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>司机信息管理</span></li>
								<li class="breadcrumb-item active"><span>司机信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="sijixingmingSearch" class="form-control form-control-sm" placeholder="请输入司机姓名" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jialing')">驾龄<i id="jialingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#sijixingmingSearch').val() != null && $('#sijixingmingSearch').val() != ''){
				searchForm.sijixingming ="%" +  $('#sijixingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("sijixinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				sijixingming : searchForm.sijixingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var jialingCell  = document.createElement('td');

						 jialingCell.innerHTML = item.jialing;

			row.appendChild(jialingCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("sijixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"sijixinxi");
