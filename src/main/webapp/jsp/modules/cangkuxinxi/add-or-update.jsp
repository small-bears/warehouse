...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑仓库信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑仓库信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">仓库信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>仓库编号</label>
										<input id="cangkubianhao" name="cangkubianhao" class="form-control" value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>仓库名称</label>
									...
									<div class="form-group col-md-6">
										<label>仓库类型</label>
										<input name="cangkuleixing" id="cangkuleixing" name="cangkuleixing" class="form-control" placeholder="仓库类型">
									</div>
									<div class="form-group col-md-6">
										<label>仓库位置</label>
	...
	<script>
		...
		function cangkubianhaoUuid(){
			if($("#cangkubianhao").val() == null || $("#cangkubianhao").val() == "null" || $("#cangkubianhao").val() == ""){
				$("#cangkubianhao").attr("value",Math.round(new Date().getTime()/1000));
			}
		}				
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "cangkuxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("cangkuxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("cangkuxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("cangkuxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#cangkuleixing").val(ruleForm.cangkuleixing);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.cangkuleixing != null && res.data.cangkuleixing != ''){

						$("#cangkuleixing").val(res.data.cangkuleixing);
						$("#cangkuleixing").attr('readonly','readonly');
					}
